...
{
    class MatrixTerminalPortNode : PollNode
    {
        private readonly static ILog log = LogManager.GetLogger(typeof(MatrixTerminalPortNode));

        public MatrixTerminalPortNode(dynamic content)
        {
        ...
        private readonly byte[] MATRIX_TERMINAL_GET_CONFIG = new byte[] { 0xF3, 0x60, 0x00, 0x00, 0x00};
