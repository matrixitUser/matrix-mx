...
{
    class TeleofisWrxConnectionNode : ConnectionNode
    {
        /// <summary>
        ...
        private static readonly ILog log = LogManager.GetLogger(typeof(TeleofisWrxConnectionNode));
        ...
        public TeleofisWrxConnectionNode(dynamic content)
        {
