...
namespace Matrix.Poll.Driver.TEM104
{
    ...
    public class SysInt
    {
        SysInt()
        {
            IntV = new RawData("V", 4, "м3");
            IntM = new RawData("M", 4, "т");
            IntQ = new RawData("Q", 4, "МВт");

            Trab = new RawData("TimeTurn", 1, "с");
            Tnar = new RawData("TimeWork", 4, "с");
            ...
            Rshv = new RawData("ConsumptionVolume", 4, "м3/ч");

            T = new RawData("Temperature", 12, "град.С");
            P = new RawData("Pressure", 12, "МПа");
        }
