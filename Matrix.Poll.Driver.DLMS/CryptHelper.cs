...
namespace Matrix.Poll.Driver.DLMS
{
    internal class CryptHelper
    {
        ...
        /// <summary>
        /// Encrypts a string into a string using a password. Uses Encrypt(byte[], byte[], byte[]).
        /// </summary>
        /// <param name="clearText">The input on which to perform the operation on.</param>
        /// <param name="password">The password used in the encryptation.</param>
        ...
        public static string Encrypt(string clearText, string password)
        {
            ...
            // This salt should be changed to random, instead of harcoding it.
        ...
        /// </summary>
        /// <param name="cipherData">Input data.</param>
        /// <param name="key">The key used to decrypt.</param>
        /// <param name="iv">An Initialization Vector used in decryptation.</param>
