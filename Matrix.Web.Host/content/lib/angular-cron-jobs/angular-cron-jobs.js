...
angular.module("cronselection.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("cronselection.html",
    ...
    "            </select>\n" +
    "        </div>\n" +
    "        <span ng-show=\"myFrequency.base >= 5\"></span>\n" +
    ...
    "            </select>\n" +
    "        </div>\n" +
    "        <span ng-show=\"myFrequency.base == 6\"></span>\n" +
    "        <!-- If Multiple is Enabled -->\n" +
    ...
    "            </select>\n" +
    "        </div>\n" +
    "        <span ng-show=\"myFrequency.base >= 2\">в </span>\n" +
    "        <!-- If Multiple is Enabled -->\n" +
    ...
    "            </select>\n" +
    "        </div>\n" +
    "        <span ng-show=\"myFrequency.base == 2\"> минут</span>\n" +
    "    </div>\n" +
    "</div>");
}]);
