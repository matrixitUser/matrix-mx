...
namespace Matrix.Web.Host.Data
{
    ...
    class TubeEvent
    {
        ...
        public List<dynamic> GetById(Guid id, Guid userId)
        {
        ...
        public IEnumerable<dynamic> GetByDateStartEnd(DateTime sDateStart, DateTime eDateStart, Guid userId)
        {
            var rows = new List<dynamic>();
        ...
        public IEnumerable<dynamic> GetActiveEventsAll()
        {
            var rows = new List<dynamic>();
