...
private bool debug = true;
        ...
        private Response4 ReadConstant(int register, bool isLongFloat = false)
        {
            Response4 result = null;
            try
            {
        ...
        public override SurveyResultData ReadCurrentValues()
        {
            ...
            try
            {
                ...
                if (current != null) OnSendMessage(string.Format("Serial Number={0}", current.Values.ElementAt(0)));
                if (current != null) data.Add(new Data("SN", MeasuringUnitType.Unknown, dateResponse.Date, current.Values.ElementAt(0)));
